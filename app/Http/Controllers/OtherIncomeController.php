...
class OtherIncomeController extends Controller
{
    ...
    public function get_other_income(Request $request)
    {
        ...
        $query = DB::table("other_income")->leftJoin("other_income_types", "other_income_types.id", "other_income.other_income_type_id")->selectRaw(DB::raw("other_income_types.name other_income_type,other_income.*"))->where('other_income.branch_id', session('branch_id'));
