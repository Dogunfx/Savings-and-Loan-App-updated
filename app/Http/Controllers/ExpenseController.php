...
class ExpenseController extends Controller
{
    ...
    public function get_expenses(Request $request)
    {
        ...
        $query = DB::table("expenses")->leftJoin("expense_types", "expense_types.id", "expenses.expense_type_id")->selectRaw(DB::raw("expense_types.name expense_type,expenses.*"))->where('expenses.branch_id', session('branch_id'));
