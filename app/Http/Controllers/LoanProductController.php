...
class LoanProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $chart = [];
        $chart_expenses = ChartOfAccount::where('account_type', 'expense')->get();

        $chart_income = ChartOfAccount::where('account_type', 'income')->get();
        $chart_liability = ChartOfAccount::where('account_type', 'liability')->get();

        $chart_equity = ChartOfAccount::where('account_type', 'equity')->get();

        $chart_assets = ChartOfAccount::where('account_type', 'asset')->get();
    ...
    public function store(Request $request)
    {
        ...
        $loan_product->check_float = $request->check_float;
